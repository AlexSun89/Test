		...
		$('.form-contact').submit(function(e){
			...
			if( $form.valid() ){
				...
				$.ajax({
					...
					data: dataString,
					success: function() {
						$submit.after('<div class="message message-success">Ваше сообщение успешно отправлено!</div>');
					},
					error: function() {
						$submit.after('<div class="message message-error">Ошибка отправки, попробуйте еще раз!</div>');
					},
					complete: function() {
